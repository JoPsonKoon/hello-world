 ...
 * generated in the org.testService.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetName_QNAME = new QName("http://service.testService.org/", "getName");
    private final static QName _GetNameResponse_QNAME = new QName("http://service.testService.org/", "getNameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.testService.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testService.org/", name = "getName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.testService.org/", name = "getNameResponse")
